...
public class Speedometer extends View implements SpeedChangeListener {
    public static final float DEFAULT_MAX_SPEED = 320; // Assuming this is km/h and you drive a super-car
    ...
    private float READING_SIZE = 100f;
...
//		Log.d(TAG, "Height spec: " + MeasureSpec.toString(heightMeasureSpec));
    ...
    private void drawReading(Canvas canvas) {
        Path path = new Path();
        String message = this.mCurrentSpeed + " km/hr";
